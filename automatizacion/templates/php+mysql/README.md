...
Entorno de desarrollo para una aplicación PHP mínima con persistencia en MySQL.
El ejemplo incluido permite validar el servidor web y la conexión con la base
de datos.
...
```bash
make crear nombre=demo_php_mysql stack=php+mysql lang=8.2 dbv=8.0
```
