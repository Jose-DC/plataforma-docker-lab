# Plantilla Node.js + MySQL

Entorno de desarrollo para una aplicación mínima en Node.js con persistencia en
MySQL. El ejemplo incluido permite comprobar la comunicación con la base de
datos.
...
```bash
make crear nombre=demo_node_mysql stack=node+mysql lang=24 dbv=8.0
```
