# Plantilla Moodle + PostgreSQL

Entorno de desarrollo para probar Moodle con PostgreSQL. La imagen de la
aplicación se construye desde `app/Dockerfile` usando la rama indicada en `.env`.
...
```bash
make crear nombre=demo_moodle_postgres stack=moodle+postgres dbv=16
```
