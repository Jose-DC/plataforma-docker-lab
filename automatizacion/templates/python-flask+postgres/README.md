# Plantilla Flask + PostgreSQL

Entorno de desarrollo para una aplicación mínima en Flask con persistencia en
PostgreSQL. El ejemplo incluido permite comprobar el arranque y la conexión con
la base de datos.
...
```bash
make crear nombre=demo_flask_postgres stack=python-flask+postgres lang=3.12 dbv=16
```
