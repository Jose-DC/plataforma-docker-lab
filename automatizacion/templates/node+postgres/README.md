# Plantilla Node.js + PostgreSQL

Entorno de desarrollo para una aplicación mínima en Node.js con persistencia en
PostgreSQL. El ejemplo incluido permite comprobar la comunicación con la base
de datos.
...
- `app`: aplicación Node.js construida desde `app/Dockerfile`.
...
```bash
make crear nombre=demo_node_postgres stack=node+postgres lang=24 dbv=16
```
